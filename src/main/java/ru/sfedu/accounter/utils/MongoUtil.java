...
public class MongoUtil {
    ...
    private static MongoClient initClient() {
        try {
            String mongoDb = ConfigurationUtil.getConfigurationEntry(Constants.MONGO_DB_CONNECTION_STRING);
    ...
    private static <T> void saveObject(T object) {
        try {
            String database = ConfigurationUtil.getConfigurationEntry(Constants.MONGO_DB_DATABASE);
            String collection = ConfigurationUtil.getConfigurationEntry(Constants.MONGO_DB_COLLECTION);
